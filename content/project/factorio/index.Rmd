...
![](pics/factorio_transport_example.png){width=500px}
...
- [Portfolio blurb on GitHub](https://github.com/zachbogart/portfolio#factorio-recipe-network)

- [Zach Bogart](https://zachbogart.com)
- [\@zachbogart](https://twitter.com/zachbogart)