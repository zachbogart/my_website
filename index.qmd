...
Out there on the interwebs, you can find me:

- [<i class="bi bi-heart-fill"></i> making some doodles️](nouns)
- [<i class="bi bi-eye-fill"></i> coding up things️️↗](https://observablehq.com/@zachbogart)
- [<i class="bi bi-chat-text-fill"></i> using different socials](socials)
...
![](images/up-smile.png){fig-align="left" width="400"}