...
## Work
- I work on the data team at [Periscopic, a socially conscious data visualization firm](), where we try to do good with data.
...
<div style="text-align: center;">[<i class="bi bi-question-octagon-fill" style="font-size: 16pt;"></i> Hard to Read? Use Dark Mode](help.qmd#legibility)</div>
