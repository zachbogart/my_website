...
<!-- Koji Link Buttons -->
<a class="btn btn-success" href="assets/koji/koji_typeface.zip" role="button"><i class="bi bi-download"></i> Try Out Koji</a>
<a class="btn btn-primary" href="assets/koji/koji-font-notes.pdf" role="button"><i class="bi bi-vector-pen"></i> Exploration and Drafting Notes</a>
<br>
...
If you try out the Koji typeface, consider [throwing a digital coffee my way](https://ko-fi.com/zachbogart). Much appreciated.
...
![](images/koji_alpha_numerals.png)

![](images/koji_secondary_alphabet.png)

![](images/koji_symbols_etc_supplement_1.png)

![](images/koji_examples.png)
